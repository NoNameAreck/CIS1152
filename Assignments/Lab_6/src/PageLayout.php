...
EOD;
	...
	public static function form_results($truncateFloat,$farenheit2Kelvin,$dodecahedronVolume,$impactVelocity) {
		 $form_results = "";
    if(!empty($truncateFloat)){
		$form_results .= "The truncated floating point value is : " . $truncateFloat . ".</br>";
	}
	if(!empty($farenheit2Kelvin)){
		
		$form_results .= "The kelvin value is : " . $farenheit2Kelvin . ".</br>";
	}
	if(!empty($dodecahedronVolume)){
		$form_results .= "The dodecahedron volume value is : " . $dodecahedronVolume . ".</br>";
	}
	if(!empty($impactVelocity)){
		$form_results .= "The impact velocity value is : " . $impactVelocity . ".</br>";
	}
